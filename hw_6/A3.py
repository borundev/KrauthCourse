...
for step in range(nsteps):
    ...
    # xnew,ynew sampled from gauss_cut() instead of uniformly
    
    xnew, ynew = gauss_cut(), gauss_cut()
    
    # the probability distribution of new and current move are now over and above the background gauss_cut move so
    # exp_new and exp_old have only the quartic piece
