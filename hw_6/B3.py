...
np.save('x_positions_levy_direct_sampling',x)
...
pylab.title('Path Sample for Harmonic-Path-Levy -- no freezing')
pylab.savefig('x_positions_levy_no_freezing.png')
pylab.clf()
...
pylab.title('levy_harmonic_path -- no freezing -- (beta=%s, N=%i)' % (beta, N))
pylab.xlim(-2, 2)
pylab.savefig('plot_B3_beta%s_levy_no_freezing.png' % beta)
pylab.show()
